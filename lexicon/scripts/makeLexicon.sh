...
SKR_SRC_HOME=/rhome/wjrogers/specialist/SKR/src
...
LCAT_HELP_FILE=${TOP}/lcat/lcat.help
export LCAT_HELP_FILE

LM_TRANSLATED_RULES_FILE=${TOP}/morph/lm_translated_rules
export LM_TRANSLATED_RULES_FILE

IM_TRANSLATED_RULES_FILE=${TOP}/morph/im_translated_rules
export IM_TRANSLATED_RULES_FILE

DM_TRANSLATED_RULES_FILE=${TOP}/morph/dm_translated_rules
export DM_TRANSLATED_RULES_FILE


 echo ../linsert/linsert -v ${LEXICON_VERSION} -l ../data/singleWordLexiconStatic${LEXICON_VERSION} -i ../data/singleWordLexiconStatic${LEXICON_VERSION}Ind -r ../data/LEXICON${LEXICON_VERSION}
time ../linsert/linsert -v ${LEXICON_VERSION} -l ../data/singleWordLexiconStatic${LEXICON_VERSION} -i ../data/singleWordLexiconStatic${LEXICON_VERSION}Ind -r ../data/LEXICON${LEXICON_VERSION} >./buildLexicon.msg 2>&1
