...
SKR_SRC_HOME=/home/wrogers/specialist/SKR/src
...
NLS=/home/wrogers/nls_projects/nls
...
../linsert/linsert -v ${LEXICON_VERSION} -l ../data/singleWordLexiconStatic${LEXICON_VERSION} -i ../data/singleWordLexiconStatic${LEXICON_VERSION}Ind -r ../data/LEXICON${LEXICON_VERSION} >./buildLexicon.msg 2>&1
