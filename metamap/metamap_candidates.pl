...
frequent_first_word_pair('benign',              'neoplasm').
...
frequent_first_word_pair('liquid',              'capsule').
frequent_first_word_pair('malignant',           'neoplasm').
frequent_first_word_pair('malignant',           'tumor').
frequent_first_word_pair('measurement',         'antibody').
...
frequent_first_word_pair('serum',               'level').
frequent_first_word_pair('serum',               'measurement').
