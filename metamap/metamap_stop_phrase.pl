...
% For 2008, we took the top 1308 entries (all those with frequency of at least 10),
% giving us 367,183 of the 417,333 stop phrases collected, i.e., 87.9832%
% The top 10 entries alone account for 50.72% of entries:
%     1    79400 and|[conj]
%     2    24693 was|[aux]
%     3    23936 )|[punc]
%     4    20775 were|[aux]
...
stop_phrase('out',[adv]).
stop_phrase('that it',[compl,pron]).
...
stop_phrase('that they',[compl,pron]).
...
stop_phrase('in vitro,',[prep,head,punc]).
stop_phrase('n',[head]).
stop_phrase('(a',[punc,det]).
stop_phrase('in both',[prep,det]).
stop_phrase('expressed',[head]).
stop_phrase('greatly',[adv]).
stop_phrase('undergo',[verb]).
stop_phrase('concerning',[verb]).
...
stop_phrase('compared.',[verb,punc]).
...
stop_phrase('taking',[verb]).
stop_phrase('without',[prep]).
stop_phrase('20',[shapes]).
stop_phrase('accompanied',[head]).
...
stop_phrase('that we',[compl,pron]).
...
stop_phrase('50',[shapes]).
stop_phrase('by comparing',[prep,head]).
...
stop_phrase('opposed',[head]).
stop_phrase('out to',[adv,adv]).
stop_phrase('perhaps',[adv]).
stop_phrase('produced',[head]).
stop_phrase('r ',[conj]).
stop_phrase('than       0.05',[prep,shapes]).
...
stop_phrase('believed to',[mod,adv]).
...
stop_phrase('dmba',[punc,det]).
stop_phrase('dmba',[punc]).
...
stop_phrase('bcnu',[punc,punc]).
stop_phrase('bcnu',[punc,shapes,punc,head]).
stop_phrase('both.',[pron,punc]).
stop_phrase('concerned',[verb]).
...
stop_phrase('phosphorylated',[head]).
...
stop_phrase('that some',[compl,pron]).
...
stop_phrase('whether they',[compl,pron]).
...
stop_phrase('; 3',[punc,shapes]).
stop_phrase('= 0.001',[punc,shapes]).
stop_phrase('acted',[verb]).
stop_phrase('agreed',[verb]).
stop_phrase('al',[head]).
stop_phrase('any,',[pron,punc]).
stop_phrase('arose',[verb]).
stop_phrase('as a consequence',[prep,det,head]).
stop_phrase('bcg',[punc]).
...
stop_phrase('; there',[punc,adv]).
stop_phrase('; this',[punc,det]).
stop_phrase('; this',[punc,pron]).
stop_phrase('= 13',[punc,shapes]).
stop_phrase('].',[punc,punc]).
...
stop_phrase('that       there',[compl,adv]).
stop_phrase('that both',[compl,det]).
...
stop_phrase('the consequence',[det,head]).
...
stop_phrase('postulated',[head]).
stop_phrase('reproduced',[verb]).
stop_phrase('s.,',[head,punc]).
stop_phrase('showing',[head]).
...
stop_phrase('whether it',[compl,pron]).
...
stop_phrase('<       0.01',[punc,shapes]).
stop_phrase('a consequence',[det,head]).
stop_phrase('a decline',[det,head]).
stop_phrase('achieved',[head]).
...
stop_phrase('that most',[compl,pron]).
...
stop_phrase('(dbp',[punc,head,punc]).
stop_phrase('(rs',[punc,head]).
...
stop_phrase('argued',[head]).
stop_phrase('at 1,',[prep,shapes,punc]).
stop_phrase('ay ',[modal]).
stop_phrase('a',[punc]).
...
stop_phrase('in a subset',[prep,det,head]).
stop_phrase('inactivating',[verb]).
stop_phrase('inferred',[verb]).
...
stop_phrase('the       influence',[det,head]).
stop_phrase('the consequences',[det,head]).
...
stop_phrase('(hlh',[punc,head]).
stop_phrase('(r2',[punc,head]).
stop_phrase('/+',[punc,punc]).
...
stop_phrase('least',[head]).
stop_phrase('making',[head]).
