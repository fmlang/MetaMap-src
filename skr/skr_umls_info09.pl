...
umls_source('GO2008_04_01',         'GO').
umls_source('GS_2009_01_11',        'GS').
umls_source('HCDT2007-2008C',       'HCDT').
umls_source('HCPCS2009',            'HCPCS').
umls_source('HCPT2009',             'HCPT').
...
umls_source('LNC226',               'LNC').
umls_source('LNC226_BRADEN_1988',   'LNC_BRADEN').
umls_source('LNC226_FLACC_1997',    'LNC_FLACC').
umls_source('LNC226_MDS20',         'LNC_MDS').
umls_source('LNC226_OASIS_2002',    'LNC_OASIS').
umls_source('LNC226_PHQ_9_1999',    'LNC_PHQ_9').
umls_source('LNC226_WHO_2006',      'LNC_WHO').
umls_source('MBD09',                'MBD').
umls_source('MCM92',                'MCM').
umls_source('MDDB_2009_01_07',      'MDDB').
umls_source('MDR11_1',              'MDR').
umls_source('MDRCZE11_1',           'MDRCZE').
umls_source('MDRDUT11_1',           'MDRDUT').
umls_source('MDRFRE11_1',           'MDRFRE').
umls_source('MDRGER11_1',           'MDRGER').
umls_source('MDRITA11_1',           'MDRITA').
umls_source('MDRJPN11_1',           'MDRJPN').
umls_source('MDRPOR11_1',           'MDRPOR').
umls_source('MDRSPA11_1',           'MDRSPA').
umls_source('MED09',                'MED').
umls_source('MEDCIN3_2008_12_13',   'MEDCIN').
umls_source('MEDLINEPLUS_20080614', 'MEDLINEPLUS').
umls_source('MMSL_2009_01_01',      'MMSL').
umls_source('MMX_2009_01_05',       'MMX').
umls_source('MSH2009_2009_02_13',   'MSH').
umls_source('MSHCZE2009',           'MSHCZE').
umls_source('MSHDUT2005',           'MSHDUT').
umls_source('MSHFIN2008',           'MSHFIN').
umls_source('MSHFRE2009',           'MSHFRE').
umls_source('MSHGER2009',           'MSHGER').
umls_source('MSHITA2009',           'MSHITA').
umls_source('MSHJPN2008',           'MSHJPN').
umls_source('MSHLAV2009',           'MSHLAV').
umls_source('MSHPOR2009',           'MSHPOR').
umls_source('MSHRUS2009',           'MSHRUS').
umls_source('MSHSPA2009',           'MSHSPA').
umls_source('MSHSWE2009',           'MSHSWE').
umls_source('MTH',                  'MTH').
umls_source('MTHCH2009',            'MTHCH').
umls_source('MTHFDA_2008_12_03',    'MTHFDA').
umls_source('MTHHH2009',            'MTHHH').
umls_source('MTHHL7V2.5_2003_08',   'MTHHL7V2.5').
umls_source('MTHICD9_2009',         'MTHICD9').
...
umls_source('MTHSPL_2009_01_26',    'MTHSPL').
umls_source('NAN2004',              'NAN').
umls_source('NCBI2008_05_07',       'NCBI').
umls_source('NCI2008_05D',          'NCI').
umls_source('NCISEER_1999',         'NCISEER').
umls_source('NDDF_2008_12_31',      'NDDF').
...
umls_source('OMIM2007_12_19',       'OMIM').
...
umls_source('RXNORM_08AB_090202F',  'RXNORM').
umls_source('SCTSPA_2008_10_31',    'SCTSPA').
umls_source('SNM2',                 'SNM').
umls_source('SNMI98',               'SNMI').
umls_source('SNOMEDCT_2008_07_31',  'SNOMEDCT').
umls_source('SNOMEDCT_2009_01_31',  'SNOMEDCT').
umls_source('SPN2003',              'SPN').
umls_source('SRC',                  'SRC').
umls_source('ULT93',                'ULT').
umls_source('UMD2009',              'UMD').
umls_source('USPMG_2004',           'USPMG').
umls_source('UWDA173',              'UWDA').
umls_source('VANDF_2009_01_06',     'VANDF').
