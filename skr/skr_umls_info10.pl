...
umls_source('FMA2_0',               'FMA').
umls_source('GO2009_04_01',         'GO').
umls_source('GS_2010_02_02',        'GS').
umls_source('HCDT2007-2008D',       'HCDT').
umls_source('HCPCS2010',            'HCPCS').
umls_source('HCPT2010',             'HCPT').
...
umls_source('ICD10PCS_2009',        'ICD10PCS').
umls_source('ICD10_1998',           'ICD10').
umls_source('ICD9CM_1998',          'ICD9CM').
umls_source('ICD9CM_2005',          'ICD9CM').
umls_source('ICD9CM_2009',          'ICD9CM').
umls_source('ICD9CM_2010',          'ICD9CM').
...
umls_source('LNC229',               'LNC').
umls_source('LNC229_BRADEN_1988',   'LNC_BRADEN').
umls_source('LNC229_CAM_2003',      'LNC_CAM').
umls_source('LNC229_FLACC_1997',    'LNC_FLACC').
umls_source('LNC229_MDS20',         'LNC_MDS20').
umls_source('LNC229_MDS30',         'LNC_MDS30').
umls_source('LNC229_OASIS_2002',    'LNC_OASIS').
umls_source('LNC229_PHQ_9_1999',    'LNC_PHQ_9').
umls_source('LNC229_RHO_2008',      'LNC_RHO').
umls_source('LNC229_WHO_2006',      'LNC_WHO').
umls_source('MBD10',                'MBD').
umls_source('MCM92',                'MCM').
umls_source('MDDB_2010_02_03',      'MDDB').
umls_source('MDR12_1',              'MDR').
umls_source('MDRCZE12_1',           'MDRCZE').
umls_source('MDRDUT12_1',           'MDRDUT').
umls_source('MDRFRE12_1',           'MDRFRE').
umls_source('MDRGER12_1',           'MDRGER').
umls_source('MDRITA12_1',           'MDRITA').
umls_source('MDRJPN12_0',           'MDRJPN').
umls_source('MDRPOR12_1',           'MDRPOR').
umls_source('MDRSPA12_1',           'MDRSPA').
umls_source('MED10',                'MED').
umls_source('MEDCIN3_2009_12_30',   'MEDCIN').
umls_source('MEDLINEPLUS_20080614', 'MEDLINEPLUS').
umls_source('MMSL_2010_02_01',      'MMSL').
umls_source('MMX_2010_02_01',       'MMX').
umls_source('MSH2010_2010_02_22',   'MSH').
umls_source('MSHCZE2010',           'MSHCZE').
umls_source('MSHDUT2005',           'MSHDUT').
umls_source('MSHFIN2008',           'MSHFIN').
umls_source('MSHFRE2010',           'MSHFRE').
umls_source('MSHGER2010',           'MSHGER').
umls_source('MSHITA2010',           'MSHITA').
umls_source('MSHJPN2008',           'MSHJPN').
umls_source('MSHLAV2010',           'MSHLAV').
umls_source('MSHPOR2010',           'MSHPOR').
umls_source('MSHRUS2010',           'MSHRUS').
umls_source('MSHSCR2010',           'MSHSCR').
umls_source('MSHSPA2010',           'MSHSPA').
umls_source('MSHSWE2010',           'MSHSWE').
umls_source('MTH',                  'MTH').
umls_source('MTHCH2010',            'MTHCH').
umls_source('MTHFDA_2010_02_01',    'MTHFDA').
umls_source('MTHHH2010',            'MTHHH').
umls_source('MTHHL7V2.5_2003_08',   'MTHHL7V2.5').
umls_source('MTHICD9_2010',         'MTHICD9').
...
umls_source('RXNORM_09AB_100301F',  'RXNORM').
umls_source('SCTSPA_2009_10_31',    'SCTSPA').
umls_source('SNM2',                 'SNM').
umls_source('SNMI98',               'SNMI').
umls_source('SNOMEDCT_2009_07_31',  'SNOMEDCT').
umls_source('SNOMEDCT_2010_01_31',  'SNOMEDCT').
umls_source('SPN2003',              'SPN').
umls_source('SRC',                  'SRC').
umls_source('ULT93',                'ULT').
umls_source('UMD2010',              'UMD').
umls_source('USPMG_2004',           'USPMG').
umls_source('UWDA173',              'UWDA').
umls_source('VANDF_2010_01_25',     'VANDF').
